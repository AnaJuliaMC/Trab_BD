...
engine = create_engine('postgresql://luanabrizola:qvkLUKZJ9Gd4@ep-bold-flower-93463717.us-east-2.aws.neon.tech/neondb?sslmode=require')
...
class Hotel(Base):
    ...
    idendereco = Column(Integer, ForeignKey('endereco.idendereco'), nullable=False)
    endereco = relationship('Endereco', back_populates='hoteis')
